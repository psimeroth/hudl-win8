...
namespace App5
{
    ...
    /// </summary>
    public sealed partial class SplitPage : App5.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            //var group = TeamResponse.GetGroup((String)navigationParameter);
            //make get schedule here
            var value = (PassToSplit)navigationParameter;

            Task<string> test2 = ServiceAccessor.MakeApiCall(AppData.URL_BASE + AppData.URL_SERVICE_GET_SCHEDULE.Replace("#",value.teamID.ToString()), "GET", "", value.Token);
            var asyncAction2 = test2.AsAsyncOperation<string>().Completed += AsyncActionHandler2;
            Group gp = new Group { Title = value.Title };
        ...
        protected override void SaveState(Dictionary<String, Object> pageState)
        {
            ...
            {
                var selectedItem = (Game)this.itemsViewSource.View.CurrentItem;
                if (selectedItem != null) pageState["SelectedItem"] = selectedItem.opponent;
            }
        }
